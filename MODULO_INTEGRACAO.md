# AG-ON Core — Guia de Integração de Módulos

Este documento descreve tudo que um módulo externo precisa saber para se integrar ao core AG-ON.

---

## 1. O que é o AG-ON Core?

O AG-ON Core é o hub central de autenticação e identidade de um ecossistema SaaS multi-tenant.
Ele gerencia:
