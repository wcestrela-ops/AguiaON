...
# Usa a mesma variável $PORT que o server.ts lê (default 3000) em vez de
# porta fixa — se alguém mudar PORT no ambiente (ex: EasyPanel configurado
# pra rodar na 80) sem isso o HEALTHCHECK continuaria batendo na 3000 e
# reportando "unhealthy" pra sempre, mesmo com o app respondendo normalmente
# na porta certa — foi exatamente esse mismatch que deixou o deploy preso em
# "amarelo" apesar dos logs mostrarem o servidor de pé.
